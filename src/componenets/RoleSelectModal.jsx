...
export default function RoleSelectionModal({ onStudentClick, onCitizenClick }) {
  return (
    <div className="text-center  h-[50vh] flex flex-col justify-center items-center bg-gradient-to-br from-green-900 via-gray-900 to-green-300 text-gray-50 px-6 py-4 gap-4">
